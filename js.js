...
window.submitOrder = async function () {
  ...
  if (window._selectedPayMethod === 'bank' && !window._bankSlipBase64)
    return _orderErr('Please attach your payment slip before submitting.'); document.getElementById('orderErr').style.display = 'none';
